...
public final class Setup {
    ...
    public static void setup(@Nonnull SimpleUtils plugin) {
        ...
        new MiningHammer(Material.IRON_PICKAXE, SlimefunItems.REINFORCED_ALLOY_INGOT, "&7強化合金", 4, 4, 5).register(plugin);
        new MiningHammer(Material.NETHERITE_PICKAXE, SlimefunItems.CARBON_CHUNK, "&8碳", 5, 5, 7).register(plugin);
